...
public class BitwiseOperExam03 {
	...
	public static void main(String[] args) {
		...
		short b =(short)0x00ff; // 0 0 15 15 =? 240 + 15 = 255
		                       // 0000 0000 1111 1111
		...
		System.out.printf("%04x\n",(short)(a&b));//A and B, %포멧 시작, 0x 는 16진수, 04x =>0x사이의 4는 출력 길이 표시
		// System.out.printf("%0x\n",(short)(a&b)); // A and B, %포멧 시작, 0x 는 16진수, \n은 escape문자

		System.out.printf("%04x\n",(short)(a&b));   // printf 쓸 때  \n 은 다음줄로 이동하라는 이스케이프문자
