...
public class Array2Exam06 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\t\t"+title); //\t 한개는 공백 4칸
		
		for(String h:head)System.out.print(h+"\t"); //h 타이틀로 head값 출력
		System.out.println("\n===========================================");
		...
		tot[j]+=score[i][j]; // 각 과목별 누적값 계산[국+국+국+국][영+영+영+영][수+수+수+수][]
			...
			System.out.println(sum+"\t"+sum/score[i].length); //평균구하기
