...
// Calendar클래스의 객체처럼  전 시스테멩 하나의 객체만 생성하여 사용해야하는 
// 경우 사용하는 클래스 선언방식 - 싱글톤
class Bank {
	String name;
	//static 멤버 - private
	//외부에서 접근할 수 없도록 캡슐화
	//클래스 로드시 Bank클래스의 객체로 초기화
	private static Bank b = new Bank("하나은행"); //Bank클래스 내부에서 접근 가능
	...
	//static멤버
	//dhlqndptj wjqrms rksmdgks apthem - public이 생략됨.
	static Bank getBank() {
		return b;
	}
}